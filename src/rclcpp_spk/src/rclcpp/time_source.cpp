...
int TimeSource::clock_cb(const rosgraph_msgs::msg::Clock::SharedPtr msg)
{
...
int TimeSource::on_parameter_event(const rcl_interfaces::msg::ParameterEvent::SharedPtr event)
{
