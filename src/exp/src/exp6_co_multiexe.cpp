...
int main(int argc, char* argv[])
{
    ...
    exec2.add_node(c1_r_cb5);
    exec2.add_node(c1_r_cb6);
    exec2.add_node(c1_r_cb7);

    exec1.add_node(c2_timer);
    exec1.add_node(c2_r_cb1);
    exec2.add_node(c2_r_cb2);

    exec2.add_node(c3_timer);
    exec2.add_node(c3_r_cb1);
    ...
    exec2.remove_node(c1_r_cb5);
    exec2.remove_node(c1_r_cb6);
    exec2.remove_node(c1_r_cb7);

    exec1.remove_node(c2_timer);
    exec1.remove_node(c2_r_cb1);
    exec2.remove_node(c2_r_cb2);

    exec2.remove_node(c3_timer);
    exec2.remove_node(c3_r_cb1);
