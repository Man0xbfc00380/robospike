...
int main(int argc, char* argv[])
{
    ...
    auto c1_timer = std::make_shared<cb_chain_demo::StartNode>("Timer_callback1", "tc1", 100, 1000, false);
    ...
    auto c1_r_cb_4 = std::make_shared<cb_chain_demo::IntermediateNode>("Regular_callback14", "tc1", "", 100, true);
    auto c1_r_cb_5 = std::make_shared<cb_chain_demo::IntermediateNode>("Regular_callback15", "tc1", "tc2", 100, true);

    auto c2_r_cb_1 = std::make_shared<cb_chain_demo::IntermediateNode>("Regular_callback21", "tc2", "tc21", 100, true);
    auto c2_r_cb_2 = std::make_shared<cb_chain_demo::IntermediateNode>("Regular_callback22", "tc21", "", 100, true);
    auto c2_r_cb_3 = std::make_shared<cb_chain_demo::IntermediateNode>("Regular_callback23", "tc2", "tc22", 100, true);
    auto c2_r_cb_4 = std::make_shared<cb_chain_demo::IntermediateNode>("Regular_callback24", "tc22", "", 100, true);
    auto c2_r_cb_5 = std::make_shared<cb_chain_demo::IntermediateNode>("Regular_callback25", "tc2", "tc23", 100, true);
    auto c2_r_cb_6 = std::make_shared<cb_chain_demo::IntermediateNode>("Regular_callback26", "tc23", "", 100, true);

    // Create executors
    int number_of_threads = 16;
    int number_of_nodelet = 1;
    rclcpp::executors::DistrThreadedExecutor exec(rclcpp::executor::ExecutorArgs(), number_of_threads, number_of_nodelet, true);
    // rclcpp::executors::MultiThreadedExecutor exec(rclcpp::executor::ExecutorArgs(), number_of_threads, true);
    ...
    exec.add_node(c1_r_cb_4); // Regular_callback14
    exec.add_node(c1_r_cb_5); // Regular_callback15
    
    exec.add_node(c2_r_cb_1); // Regular_callback21
    exec.add_node(c2_r_cb_2); // Regular_callback22
    exec.add_node(c2_r_cb_3); // Regular_callback23
    exec.add_node(c2_r_cb_4); // Regular_callback24
    exec.add_node(c2_r_cb_5); // Regular_callback25
    exec.add_node(c2_r_cb_6); // Regular_callback26
    ...
    exec.remove_node(c1_r_cb_1); // Regular_callback11
    exec.remove_node(c1_r_cb_2); // Regular_callback12
    exec.remove_node(c1_r_cb_3); // Regular_callback13
    exec.remove_node(c1_r_cb_4); // Regular_callback14
    exec.remove_node(c1_r_cb_5); // Regular_callback15
    
    exec.remove_node(c2_r_cb_1); // Regular_callback21
    exec.remove_node(c2_r_cb_2); // Regular_callback22
    exec.remove_node(c2_r_cb_3); // Regular_callback23
    exec.remove_node(c2_r_cb_4); // Regular_callback24
    exec.remove_node(c2_r_cb_5); // Regular_callback25
    exec.remove_node(c2_r_cb_6); // Regular_callback26
