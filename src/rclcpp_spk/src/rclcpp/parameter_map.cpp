...
rclcpp::parameter_map_from(const rcl_params_t * const c_params)
{
  ...
  for (int n = 0; n < c_params->num_nodes; ++n) {
    ...
    for (int p = 0; p < c_params_node->num_params; ++p) {
...
rclcpp::parameter_value_from(const rcl_variant_t * const c_param_value)
{
  ...
  if (c_param_value->bool_value) {
    ...
    for (int v = 0; v < byte_array->size; ++v) {
    ...
    for (int v = 0; v < bool_array->size; ++v) {
    ...
    for (int v = 0; v < int_array->size; ++v) {
    ...
    for (int v = 0; v < double_array->size; ++v) {
    ...
    for (int v = 0; v < string_array->size; ++v) {
